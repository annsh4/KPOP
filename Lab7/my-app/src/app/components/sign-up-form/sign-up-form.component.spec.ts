...
describe('SignUpFormComponent', () => {
  ...
  it('form is invalid', () => {
    ...
    component.formModel.fullName = 'Anna Tereshchuk';
    fixture.detectChanges();
  ...
  it('login is empty', () => {
    const nativeElement = fixture.nativeElement;
    expect(nativeElement.querySelector('#login-error').textContent).toBe('Введите логин');
    component.formModel.login = '##!43';
    fixture.detectChanges();
    expect(nativeElement.querySelector('#login-error').textContent).toBe('Логин должен состоять только из латинских букв либо цифр');
    component.formModel.login = 'somelogin';
    fixture.detectChanges();
  ...
  it('email is empty or invalid', () => {
    const nativeElement = fixture.nativeElement;
    expect(nativeElement.querySelector('#email-error').textContent).toBe('Введите Email адрес');
    component.formModel.email = 'someemail';
    fixture.detectChanges();
    expect(nativeElement.querySelector('#email-error').textContent).toBe('Неверный Email адрес');
  ...
  it('icq is invalid', () => {
    ...
    fixture.detectChanges();
    expect(nativeElement.querySelector('#icq-error').textContent).toBe('Неверный номер');
  ...
  it('skype is invalid', () => {
    ...
    fixture.detectChanges();
    expect(nativeElement.querySelector('#skype-error').textContent).toBe('Ник Skype должен состоять только из латинских букв либо цифр');
